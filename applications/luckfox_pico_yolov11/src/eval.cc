  ...
  system("RkLunch-stop.sh");
    ...
    while(1){	
        ...
        for (size_t frame_index = 0; frame_index < NUM_FRAMES; frame_index++){
            ...
            // Safely force the loaded image directly into our DMA-backed 'frame'
            cv::resize(loaded_img, frame, cv::Size(width, height));
        ...
        printf(">>> Avg Inference D: %lld ms <<<\n", total_inference_time / NUM_FRAMES);
    }
